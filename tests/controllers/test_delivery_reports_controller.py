...
from message_media_messages.models.confirm_delivery_reports_as_received_request \
    import ConfirmDeliveryReportsAsReceivedRequest
...
class DeliveryReportsControllerTests(ControllerTestBase):
    ...
    def test_confirm_delivery_reports_as_received_1(self):
        ...
        # Perform the API call through the SDK function
        result = self.controller.create_confirm_delivery_reports_as_received(body)
