...
class RepliesControllerTests(ControllerTestBase):
    ...
    def test_confirm_replies_as_received_1(self):
        ...
        result = self.controller.create_confirm_replies_as_received(body)
