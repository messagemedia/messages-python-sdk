...
class BaseController(object):
    ...
    def validate_response(self, response):
        ...
        if response.status_code == 402:
            raise APIException('The feature that you are trying to use is disabled by default. Please contact tech support at support@messagemedia.com.au', response)
        elif response.status_code == 404:
            raise APIException('The specified resource does not exist.', response)
