...
from messages.models.check_replies_response import CheckRepliesResponse
...
class RepliesController(BaseController):
    ...
    def __init__(self, config, auth_managers):
        super(RepliesController, self).__init__(config, auth_managers)
    ...
    def get_check_replies(self):
        ...
        *Note: It is recommended to use the Webhooks feature to receive reply
        ...
        decoded = APIHelper.json_deserialize(_response.text, CheckRepliesResponse.from_dictionary)
