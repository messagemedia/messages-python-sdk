...
class ConfirmDeliveryReportsAsReceivedRequest1(object):

    """Implementation of the 'Confirm delivery reports as received request1' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ConfirmDeliveryReportsAsReceivedRequest1 class"""
